...
import static at.molindo.utils.collections.ArrayUtils.get;
...
public class ArrayUtilsTest {
	...
	@Test
	public void testGet() {
		assertNull(get((Object[]) null, 0, null));
		assertNull(get(new Object[0], 0, null));
		assertEquals("foo", get(new Object[] { "foo" }, 0));
	}
