...
public class IntValue implements Comparable<IntValue>, Serializable {
	 ...
	 * @return <code>true</code> if this <code>IntValue</code> is greater than
	 ...
	 * @param that
	 *            the <code>int</code> value to compare with
	 * @return <code>true</code> if this <code>IntValue</code> is less than the
	 *         given <code>int</code> value
	 */
