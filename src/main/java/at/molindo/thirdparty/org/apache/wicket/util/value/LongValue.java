...
import at.molindo.thirdparty.org.apache.wicket.util.lang.Primitives;

/**
 * A base class based on the Java <code>long</code> primitive for value classes
 * that want to implement standard operations on that value without the pain of
 * aggregating a <code>Long</code> object.
 * 
...
public class LongValue implements Comparable<LongValue>, Serializable {
	 ...
	 * @param that
	 *            the <code>Object</code> to compare with
	 * @return <code>true</code> if this <code>Object</code>'s value is equal to
	 *         the given <code>Object</code>'s value
	 */
	@Override
	 ...
	 * @return <code>true</code> if this <code>LongValue</code> is greater than
	 ...
	 * @param that
	 *            the <code>long</code> value to compare with
	 * @return <code>true</code> if this <code>LongValue</code> is less than the
