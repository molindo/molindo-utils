 ...
 * and static data. <p> This interface is public for historical purposes. You
 * should have no need to use it. </p>
 */
public interface BZip2Constants {
	 ...
	 * is.
	 * 
	 * <p> FIXME: This array should be in a private or package private location,
	 * since it could be modified by malicious code. </p>
	 */
	int[] rNums = { 619, 720, 127, 481, 931, 816, 813, 233, 566, 247, 985, 724, 205, 454, 863, 491, 741, 242, 949, 214,
			...
			811, 169, 869, 675, 611, 697, 867, 561, 862, 687, 507, 283, 482, 129, 807, 591, 733, 623, 150, 238, 59,
			379, 684, 877, 625, 169, 643, 105, 170, 607, 520, 932, 727, 476, 693, 425, 174, 647, 73, 122, 335, 530,
