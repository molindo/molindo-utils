 ...
 * 
 * <p>Mainly intended for usage within the framework, resolving method parameter
...
public abstract class GenericTypeResolver {
	...
	private static Class<?>[] doResolveTypeArguments(Class<?> ownerClass, Class<?> classToIntrospect,
			Class<?> genericIfc) {
	 ...
	 * supplied {@link Map}. <p>Consider this case: <pre class="code> public
	 * interface Foo<S, T> { .. }
	 * 
