...
package at.molindo.thirdparty.org.springframework.core;
...
public class MethodParameter {
	...
	/**
	 * Return the wrapped Method, if any. <p>Note: Either Method or Constructor
	 * is available.
	 * 
	...
	/**
	 * Return the wrapped Constructor, if any. <p>Note: Either Method or
	...
	public <T extends Annotation> T getMethodAnnotation(Class<T> annotationType) {
		return this.method != null ? this.method.getAnnotation(annotationType) : (T) this.constructor
	...
	/**
	 * Initialize parameter name discovery for this method parameter. <p>This
	 * method does not actually try to retrieve the parameter name at this
	...
	/**
	 * Create a new MethodParameter for the given method or constructor. <p>This
	 * is a convenience constructor for scenarios where a Method or Constructor
